/* NEXORA — École primaire interactive V601
   Pédagogie CP1 : deux explications complémentaires avant les exercices corrigés.
   Contrat public conservé : window.NexoraPrimarySchoolV157.open(). */
(function () {
  'use strict';
  if (window.__nxPrimaryExercisesV601) return;
  window.__nxPrimaryExercisesV601 = true;
